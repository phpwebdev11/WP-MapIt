...
if ( ! class_exists( 'Wp_Mapit_Gutenberg_Block' ) ) {
	...
	class Wp_Mapit_Gutenberg_Block {
		...
		public static function init_block() {
			...
			wp_register_script( 'wp-mapit-gutenberg-js', WP_MAPIT_URL . 'js/wp_mapit_gutenberg.js', array( 'wp-i18n', 'wp-element', 'wp-blocks', 'wp-components', 'wp-editor' ), filemtime( WP_MAPIT_DIR . 'js/wp_mapit_gutenberg.js' ), true );
