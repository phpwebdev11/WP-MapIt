...
if ( ! class_exists( 'Wp_Mapit_Map' ) ) {
	...
	class Wp_Mapit_Map {
		...
		public static function get_map_marker_hover( $post_id ) {
			$marker_hover = trim( get_post_meta( $post_id, 'wpmi_marker_hover', true ) );
